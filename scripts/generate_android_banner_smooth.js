...
async function generateAndroidBannerSmooth() {
  const htmlContent = `
<!DOCTYPE html>
<html>
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Ultra-Smooth 3D Extruded Object Shield (No Jagged Edges) */
    .thick-3d-shield {
      width: 170px;
      height: 190px;
      position: relative;
...
<body>
  ...
  <div class="banner-container">
    ...
    <div class="right-col">
      ...
      <!-- Ultra-Smooth 3D Extruded Shield Badge -->
  ...
  // Render at 2x super-sampling scale (2048 x 1000) for sub-pixel anti-aliasing
  ...
  const tempPath = path.resolve('public/temp_2048x1000.png');
  ...
  console.log('Successfully generated Ultra-Smooth Anti-Aliased 1024 x 500 px Android Feature Graphic!');
}

generateAndroidBannerSmooth().catch(console.error);
